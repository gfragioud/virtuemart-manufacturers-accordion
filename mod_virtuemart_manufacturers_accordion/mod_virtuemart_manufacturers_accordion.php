...
VmConfig::loadConfig();
vmLanguage::loadJLang('mod_virtuemart_manufacturers_accordion', true);
...
// load the template
require JModuleHelper::getLayoutPath('mod_virtuemart_manufacturers_accordion', $params->get('layout', 'default'));
?>